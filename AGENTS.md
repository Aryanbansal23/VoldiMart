# AI Coding Agent Instructions for VoldiMart E-commerce

## Project Overview

**VoldiMart** is a production-ready, full-stack MERN (MongoDB, Express, React, Node.js) e-commerce application featuring:
